...
public class ConcatenationVisitorTest {
  ...
  private static final DateColumn ANY_DATE_COLUMN =
      DateColumn.of("any_date", LocalDate.now(Clock.systemUTC()));
  private static final TimeColumn ANY_TIME_COLUMN =
      TimeColumn.of("any_time", LocalTime.now(Clock.systemUTC()));
  private static final TimestampColumn ANY_TIMESTAMP_COLUMN =
      TimestampColumn.of("any_timestamp", LocalDateTime.now(Clock.systemUTC()));
  private static final TimestampTZColumn ANY_TIMESTAMPTZ_COLUMN =
      TimestampTZColumn.of("any_timestamp_tz", Instant.now());
