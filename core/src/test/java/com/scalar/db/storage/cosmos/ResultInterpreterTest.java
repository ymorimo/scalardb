...
public class ResultInterpreterTest {
  ...
  public void interpret_ShouldReturnWhatsSet() {
    ...
    Map<String, Object> recordValues =
        ImmutableMap.<String, Object>builder()
            ...
            .put(ANY_COLUMN_NAME_3, BigIntColumn.MAX_VALUE)
    ...
    // Act
    Result result = interpreter.interpret(record);
  ...
  public void interpret_ShouldReturnWhatsSetWithNullValues() {
    ...
    recordValues.put(ANY_COLUMN_NAME_8, null);
    recordValues.put(ANY_COLUMN_NAME_9, null);
    recordValues.put(ANY_COLUMN_NAME_10, null);
    recordValues.put(ANY_COLUMN_NAME_11, null);
    Record record =
        new Record(
            ANY_ID_1,
            ANY_TEXT_1,
