...
public class BlobTestUtils {
  public static TextColumn getMinTextValue(String columnName) {
    // Since Blob can't handle an empty string correctly, we use "0" as the min value
    return TextColumn.of(columnName, "0");
  }

  public static TextColumn getMaxTextValue(String columnName) {
    // Since Blob can't handle 0xFF character correctly, we use "ZZZ..." as the max value
