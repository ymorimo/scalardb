...
public class TimestampColumn implements Column<Instant> {

  private final String name;
  @Nullable private final Instant value;

  private TimestampColumn(String name, @Nullable Instant value) {
   ...
   */
  public static TimestampColumn of(String columnName, Instant value) {
