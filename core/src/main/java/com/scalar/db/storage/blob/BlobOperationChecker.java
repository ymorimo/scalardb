...
public class BlobOperationChecker extends OperationChecker {
  private static final char[] ILLEGAL_CHARACTERS_IN_PRIMARY_KEY = {
    '*', '/',
    // TODO: Add more illegal characters
  };

  public BlobOperationChecker(DatabaseConfig databaseConfig, TableMetadataManager metadataManager) {
