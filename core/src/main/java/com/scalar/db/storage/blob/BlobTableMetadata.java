...
@Immutable
public class BlobTableMetadata extends BlobDatabaseObject {
  ...
  public BlobTableMetadata(TableMetadata tableMetadata) {
  ...
  private BlobTableMetadata(Builder builder) {
    this(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BlobTableMetadata)) {
      return false;
    }
    BlobTableMetadata that = (BlobTableMetadata) o;
  ...
  public static final class Builder {
    ...
    public BlobTableMetadata build() {
      return new BlobTableMetadata(this);
    }
  }
}
